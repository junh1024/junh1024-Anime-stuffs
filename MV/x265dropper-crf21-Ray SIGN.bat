set filterstring=-vf decimate,scale=1280:720:flags=spline,hqdn3d=1
REM 
...
REM ffmpeg -ss 21  -i "%~f1" %filterstring% -t 0.1 "%~n1_out.png" 
REM FOR %%s IN (a) DO (

ffmpeg  -loglevel error  -i "%~f1" %filterstring%  -pix_fmt yuv420p10le  -strict -1 -f yuv4mpegpipe - | x265-10b-25 -F 1   --csv  x265logs.csv   --colorprim bt709 --transfer  bt709 --colormatrix  bt709 --preset slow   --crf 21  --y4m --sar 1   --input - -o "%~f1-spl.hevc"
REM )
